...
class PassportFrame(LabelFrame):
    def __init__(self, database):
        ...
        frame_a0 = Frame(frame_a, bd=5)
        frame_a0.pack(side=LEFT)
        ...
        frame_a1 = Frame(frame_a, bd=5)
        frame_a1.pack(side=LEFT)
        ...
        frame_a2 = Frame(frame_a, bd=5)
        frame_a2.pack(side=LEFT)
        ...
        smart_label_b30.pack(side=LEFT, expand=True)
        smart_label_b31 = SmartLabel(frame_b3, text='Комсомольский район')
        smart_label_b31.pack(side=LEFT, expand=True)
        smart_label_b32 = SmartLabel(frame_b3, text='г. Комсомольск-на-Амуре')
        smart_label_b32.pack(side=LEFT, expand=True)
        ...
        smart_label_b60 = SmartLabel(frame_b6, text='паспорта')
        smart_label_b60.pack(side=LEFT)

        # пункт 2
        frame_c = Frame(self, bd=5)
        frame_c.pack(fill=X)
        ...
        smart_label_c20.pack(side=LEFT, expand=True)
        smart_label_c21 = SmartLabel(frame_c2, text='личное заявление')
        smart_label_c21.pack(side=LEFT, expand=True)
