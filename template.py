...
def create_pdf(filename, data):
    ...
    liner('Normal+', 'Фамилия, имя, отчество', report[1])
    liner('Normal+', 'Дата рождения', data_[1][1])
    liner('Normal+', 'Адрес места жительства', data_[1][2])
    liner(
        'Normal+',
    ...
    spacer(1)
    liner('Normal+', '5. Кем освидетельствован', data_[5][0])
    liner(
        'Normal+',
